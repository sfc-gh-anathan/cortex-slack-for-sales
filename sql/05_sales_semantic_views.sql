...
SELECT 
    ...
    de.ACCESS_LEVEL,
    de.CAN_VIEW_COMPENSATION,
    de.CAN_VIEW_INDIVIDUAL_PERFORMANCE,
    de.CAN_VIEW_TEAM_PERFORMANCE,
    de.CAN_VIEW_CUSTOMER_DATA,
...
FROM SALES_PERFORMANCE sp
    ...
    LEFT JOIN DATA_ENTITLEMENTS de ON se.EMPLOYEE_ID = de.EMPLOYEE_ID 
        AND de.EFFECTIVE_DATE <= CURRENT_DATE() 
        AND (de.EXPIRY_DATE IS NULL OR de.EXPIRY_DATE >= CURRENT_DATE())
